...
public class ScrollAutotrophy extends ScrollEffectNegation {
    public ScrollAutotrophy() {
        super(
                NamespacedKey.fromString("autotrophy", plugin()),
        ...
        this.generators = new ScrollGenerator[] {
                new ScrollGeneratorMonsterDrop(0.01, EntityType.HUSK),
                new ScrollGeneratorTreasure(0.4, Chest.class, Structure.DESERT_PYRAMID)
        };
    }
}
