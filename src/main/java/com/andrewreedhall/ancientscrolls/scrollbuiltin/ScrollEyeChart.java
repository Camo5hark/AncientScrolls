...
public class ScrollEyeChart extends ScrollEffectNegation {
    public ScrollEyeChart() {
        super(
                NamespacedKey.fromString("eyechart", plugin()),
        ...
        this.generators = new ScrollGenerator[] {
                new ScrollGeneratorTreasure(0.4, Chest.class, Structure.SHIPWRECK),
                new ScrollGeneratorTreasure(0.4, Chest.class, Structure.SHIPWRECK_BEACHED)
        };
    }
}
