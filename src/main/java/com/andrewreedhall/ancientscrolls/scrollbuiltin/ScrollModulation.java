...
public class ScrollModulation extends ScrollEffectNegation {
    public ScrollModulation() {
        super(
                NamespacedKey.fromString("modulation", plugin()),
        ...
        this.generators = new ScrollGenerator[] {
                new ScrollGeneratorMonsterDrop(0.05, EntityType.SHULKER)
        };
    }
}
